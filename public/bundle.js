...
ReactDOM.render(React.createElement(_App2.default, { width: window.innerWidth, height: window.innerHeight }), placeToMount);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.spawnBubble = _this.spawnBubble.bind(_this);
    _this.moveBubbles = _this.moveBubbles.bind(_this);
    _this.spawnBubbleOnInterval = _this.spawnBubbleOnInterval.bind(_this);

    _this.spawnBubbleOnInterval();
    // this.spawnBubble()
    // this.spawnBubble()
    // this.spawnBubble()
    // this.spawnBubble()
  ...
  _createClass(App, [{
    key: 'spawnBubbleOnInterval',
    value: function spawnBubbleOnInterval() {
      window.setTimeout(this.spawnBubble, 1000);
    }
  }, {
    key: 'spawnBubble',
    value: function spawnBubble() {
      var cx = Math.floor(Math.random() * this.props.width);
      var r = Math.floor(15 + Math.random() * (30 - 10));
      var bubble = { r: r, cx: cx, cy: 800, tx: Math.floor(Math.random() * 5) - 2.5 };
      console.log(cx);
      this.state.libraryOfBubbles.push(bubble);
    }
  }, {
    key: 'moveBubbles',
    value: function moveBubbles() {
      console.log("moveBubbles");
      var libraryOfBubbles = this.state.libraryOfBubbles;

      libraryOfBubbles = libraryOfBubbles.map(function (bubble) {
      ...
      this.setState({ libraryOfBubbles: libraryOfBubbles });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.state.libraryOfBubbles.map(function (bubble) {
          return _react2.default.createElement(_Bubble2.default, { r: bubble.r, cx: bubble.cx, cy: bubble.cy });
        })
      );
    }
  }]);
...
var Bubble = function (_React$Component) {
  ...
  _createClass(Bubble, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      this.setState({ r: r, cx: cx, cy: cy });
    }
  }, {
    key: "render",
    value: function render() {
      console.log(this.state, this.props);
      return _react2.default.createElement("circle", { r: this.props.r, cx: this.props.cx, cy: this.props.cy, fill: "#FF53FF", fillOpacity: .5, stroke: "#AA1561" });
    }
  }]);
...
var _TransitionGroup = __webpack_require__(28);

var _TransitionGroup2 = _interopRequireDefault(_TransitionGroup);

var _CSSTransitionGroupChild = __webpack_require__(32);
...
var _chainFunction = __webpack_require__(29);
...
var _ChildMapping = __webpack_require__(31);
...
var _addClass = __webpack_require__(33);
...
var _requestAnimationFrame = __webpack_require__(36);
